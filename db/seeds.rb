...
trekk1.markers.create(
  marker_image: 'https://i.ibb.co/QkXpp99/target-Photo1.png',
...
trekk1.markers.create(
  marker_image: 'https://i.ibb.co/M5zcctr/target-Photo2.png',
...
trekk1.markers.create(
  marker_image: 'https://i.ibb.co/x3Yzqt1/target-Photo3.png',
...
trekk1.markers.create(
  marker_image: 'https://i.ibb.co/xhVK3nq/target-Photo4.png',
...
trekk1.markers.create(
  marker_image: 'https://i.ibb.co/g4LcX4g/target-Photo5.png',
...
trekk1.markers.create(
  marker_image: 'https://i.ibb.co/09PbqDg/target-Photo6.png',
